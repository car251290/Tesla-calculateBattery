...
import { getModelData } from '../../service/BatteryService';
import TeslaClimate from '../TeslaClimate/TeslaClimate';
import TeslaWheels from '../TeslaWheels/TeslaWheels';
import useStatesHooks from './useStatehook';

function  TeslaBattery (props) {
  const { carstats, config,setCarstats,setConfig } = useStatesHooks();
